...
static FILE *do_fopen(char const *cmd, char const *fname, char const *mode);
static HXFILE *do_hxopen(char const *cmd, char const *name, int mode);
...
help()
{
    fputs("Usage: chx [options] command arg...\n"
          "OPTIONS:\n"
